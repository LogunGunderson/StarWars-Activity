...
ggplot(starwars, 
  ...
  geom_point(color = "pink") +
  labs(
    title = "Relationship between Mass and Height by Birth Year for Star Wars Characters",
    x = "Height (cm)", 
    y = "Mass (kg)",
    size = "Birth Year"
    )
...
ggplot(starwars, aes(y = homeworld)) +
  geom_bar(color = "pink") +
  labs(title = "Homeworld of Star Wars Characters", y = "Homeworld")
```
...
ggplot(starwars, aes(x = birth_year)) +
  geom_histogram(binwidth = 13, color = "pink") +
  labs(title = "Birth Year of Star Wars Characters", x = "Birth Year")
```
...
```{r num-cat}
ggplot(starwars, aes(x = birth_year, fill = species)) +
  geom_histogram(binwidth = 18, color = "pink") +
  labs(title = "Birth Year of Star Wars Characters by Species", x = "Birth Year")
```
...
```{r cat-cat}
ggplot(starwars, aes(x = gender, fill = films)) +
  geom_bar(position = "fill") +
  labs(title = "Gender of Star Wars Characters by Films", x = "Gender")
```
...
```{r multi}
ggplot(starwars %>% filter(mass < 500), 
